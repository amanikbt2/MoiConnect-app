...
export function FlameIcon({ color = '#ea580c', size = 16, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M12 2C10.5 4.5 9 7.5 9 10C9 13.31 11.69 16 15 16C17.5 16 19 14.5 19 12C20.5 13.5 21 16 20 18.5C19 21 16.5 22.5 13.5 22.5C9.5 22.5 6 19.5 6 15C6 10 9.5 6 12 2Z"
        fill={color}
      />
    </Svg>
  );
}
export function TrendingUpIcon({ color = '#16a34a', size = 16, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
...
export function ZapIcon({ color = '#2563eb', size = 16, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
...
export function DocumentIcon({ color = '#15803d', size = 16, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z"
...
export function PastPaperIcon({ color = '#15803d', size = 18, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z"
...
export function CatPaperIcon({ color = '#15803d', size = 18, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
...
export function LectureNotesIcon({ color = '#15803d', size = 18, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V4H6.5A2.5 2.5 0 0 0 4 6.5V19.5ZM4 19.5A2.5 2.5 0 0 0 6.5 22H20"
...
export function LightbulbIcon({ color = '#15803d', size = 18, style }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M9 18H15M10 21H14M12 2C8.13401 2 5 5.13401 5 9C5 11.381 6.19 13.474 8 14.74V16C8 16.5523 8.44772 17 9 17H15C15.5523 17 16 16.5523 16 16V14.74C17.81 13.474 19 11.381 19 9C19 5.13401 15.866 2 12 2Z"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
